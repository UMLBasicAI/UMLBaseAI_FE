        ...
        const handleResize = (e: MouseEvent) => {
            if (isResizingLeft) {
                ...
                const newWidth = Math.min(
                    Math.max(
                        initialLeftWidthRef.current + deltaX,
                        minLeftWidth,
                    ),
                    maxLeftWidth,
                )
    ...
    return (
        <div className="flex h-full" style={{ zIndex: 100 }}>
            ...
            <button
                ...
                className={`absolute left-0 top-1/2 z-20 -translate-y-1/2 transform rounded-r-md border border-gray-200 bg-white p-1 text-gray-500 transition-all duration-300 hover:text-gray-700 focus:outline-none ${
